      ...
      >
              ...
              hvr ?
                <animated.div style={style}>
                  <IconContext.Provider value={isFav ? { color: 'gold', size: '20px' } : { color: 'rgb(51 65 85)', size: '20px' }}>
                    <IoStar onClick={!isFav ? handleAddToFavorites : handleRemFavorites} className={`absolute ml-1 h-[28px] w-[28px]  mt-1 ${favLoading ? " animate-pulse" : ""}`} />
        ...
        <div className=' mt-4 ml-4'>
          <Link to={`/blog/` + blog.$id}>
            <span className='font-bold hover:text-violet-600 transition-[0.2s]'>{blog?.title}</span> <br />
