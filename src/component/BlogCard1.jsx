  ...
  return (
    <>
      <Link to={`/blog/` + blog.$id}>
        <div className='w-[340px] h-[364px] rounded-lg bg-white pb-10 hover:shadow-[0_0_10px_gray] transition-[0.2s] animate-bounce blogcardanim'>
          ...
          <div className=' mt-4 ml-4'>
            ...
            <span className='inline-block mt-2 text-gray-700'>{blog?.publishedOn}</span>
          </div>
        </div>
      </Link>
    </>
