...
export default function BlogPage() {
  ...
  const handleComment = async () => {
    ...
    await blogService.addComment(blog_id, updatedCommentsArr);
    setCommentV("");
  }
  if (loading)
          ...
          item ? null :
            <>
              ...
              <animated.div style={style} className='md:w-[1000px] w-full md:mt-20 mt-[60px] md:rounded-2xl bg-white md:mb-4 shadow-[0_0_10px_0_gray] flex flex-col items-center'>
                ...
                <button onClick={commentV && handleComment} className='cbtn md:w-[100px] w-1/4 outline-none hover:scale-105 active:scale-90 transition-[0.2s] h-[40px] ml-auto md:mr-10 mr-4'>Post</button> <hr className='h-[6px] w-11/12 mt-4 bg-[#e9e9e9]' />
